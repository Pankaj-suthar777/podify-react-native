...
router.post("/verify-email", (0, validator_1.validate)(validationSchema_1.TokenAndIDValidation), auth_1.verfiyEmail);
router.post("/re-verify-email", auth_1.sendReVerificationToken);
router.post("/forgot-password", auth_1.generateForgetPasswordLink);
...
router.post("/update-password", (0, validator_1.validate)(validationSchema_1.UpdatePassowrdSchema), auth_2.isValidPassResetToken, auth_1.updatePassword);
