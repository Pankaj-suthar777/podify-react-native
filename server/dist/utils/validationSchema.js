...
exports.UpdateHistorySchema = exports.OldPlaylistValidationSchema = exports.NewPlaylistValidationSchema = exports.AudioValidationSchema = exports.SignInValidationSchema = exports.UpdatePassowrdSchema = exports.TokenAndIDValidation = exports.CreateUserSchema = void 0;
...
exports.UpdatePassowrdSchema = yup.object().shape({
    token: yup.string().trim().required("Invalid token!"),
    userId: yup
        .string()
        .transform(function (value) {
