...
exports.logOut = exports.sendProfile = exports.updateProfile = exports.signIn = exports.updatePassword = exports.grantValid = exports.generateForgetPasswordLink = exports.sendReVerificationToken = exports.verfiyEmail = exports.create = void 0;
const emailVerificationToken_1 = __importDefault(require("#/models/emailVerificationToken"));
const emailVerificationToken_2 = __importDefault(require("#/models/emailVerificationToken"));
...
const verfiyEmail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { token, userId } = req.body;
    const verificationToken = yield emailVerificationToken_2.default.findOne({
        owner: userId,
    });
    ...
    yield emailVerificationToken_2.default.findByIdAndDelete(verificationToken._id);
    res.json({ message: "Your email is verified" });
});
exports.verfiyEmail = verfiyEmail;
const sendReVerificationToken = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield emailVerificationToken_2.default.findOneAndDelete({
        owner: userId,
    });
    const token = (0, helper_1.generateToken)();
    yield emailVerificationToken_2.default.create({
        owner: userId,
        token,
    });
...
const updateProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (avatar) {
        if ((_c = user.avatar) === null || _c === void 0 ? void 0 : _c.publicId) {
            yield cloud_1.default.uploader.destroy((_d = user.avatar) === null || _d === void 0 ? void 0 : _d.publicId);
        }
